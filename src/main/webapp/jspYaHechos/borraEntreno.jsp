...
<%
    ...
    int codigo = -1;
    try {
        codigo = Integer.parseInt(request.getParameter("codigoE"));
...
//<<<<<<
            ...
            String sql = "DELETE FROM entrenamiento WHERE entrenoID = ?";
            ...
            System.out.println("Entrenos BORRADOS:  " + filasAfectadas);
...
<script>document.location = "listadoEntreno.jsp"</script>
</body>
</html>
